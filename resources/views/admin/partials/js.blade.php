...
<!-- Page level plugins -->
<script src="{{ asset('vendor/admin/vendor/datatables/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('vendor/admin/vendor/datatables/dataTables.bootstrap4.min.js') }}"></script>
